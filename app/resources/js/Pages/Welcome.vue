        ...
        <section class="relative max-w-7xl mx-auto px-4 sm:px-6 pt-6 pb-12 sm:pt-10 sm:pb-20 lg:pt-16 lg:pb-32">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative h-[280px] sm:h-[400px] lg:h-[500px] overflow-hidden">
                    <!-- Glow background -->
                    <div class="absolute inset-0 bg-gradient-to-br from-indigo-400/20 via-violet-400/10 to-transparent dark:from-indigo-600/20 dark:via-violet-600/10 rounded-3xl blur-2xl"></div>
                    <!-- Floating particles -->
