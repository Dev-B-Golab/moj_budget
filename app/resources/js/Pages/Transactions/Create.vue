...
const initialType = ['expense', 'income'].includes(urlParams.get('type')) ? urlParams.get('type') : 'expense';
...
<template>
    <Head title="Dodaj transakcję" />
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Dodaj transakcję</h2>
        </template>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6">
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input v-model="form.description" type="text" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200" placeholder="Np. Zakupy w Biedronce" />
                        ...
                        <div class="flex items-center justify-between pt-4">
                            <Link :href="route('transactions.index')" class="text-gray-500 dark:text-gray-400 hover:underline text-sm">Anuluj</Link>
